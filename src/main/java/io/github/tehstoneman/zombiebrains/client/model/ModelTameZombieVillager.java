...
public class ModelTameZombieVillager extends ModelBiped
{
    private static final String __OBFID = "CL_00000865";

    public ModelTameZombieVillager()
    {
        this(0.0F, 0.0F, false);
    }

    public ModelTameZombieVillager(float p_i1165_1_, float p_i1165_2_, boolean p_i1165_3_)
    {
